...
The production baseline requires at least 80% overall coverage. This threshold
also applies to the first application pull request; there is no hidden
bootstrap bypass. Coverage output states the active threshold before reporting
the measured result.
