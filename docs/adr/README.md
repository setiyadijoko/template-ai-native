...
| [0010](0010-activate-profile-aware-controls-through-a-stable-aggregate.md) | Activate profile-aware controls through a stable aggregate | Accepted — protected-consumer enforcement evidence passed; duplicate removal staged separately | 2026-08-11 |
